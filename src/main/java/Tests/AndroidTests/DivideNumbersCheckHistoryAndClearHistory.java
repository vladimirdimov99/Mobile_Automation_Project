...
public class DivideNumbersCheckHistoryAndClearHistory {
    AppiumDriver driver;
    ...
    public void DivideNumbers() {
        ...
        androidCalculatorApplication.selectDivideSign();
        androidCalculatorApplication.selectANumber();
    ...
    @Test(priority = 4)
    public void ClearCalculatorHistoryAndCheckIfHistoryButtonIsClickable(){
        AndroidCalculatorApplication androidCalculatorApplication = new AndroidCalculatorApplication(driver);
        androidCalculatorApplication.selectClearHistoryButton();
        //History button should be inactive since we already cleared the Calculator's history
        Assert.assertFalse(driver.findElement(androidCalculatorApplication.historyButton).isEnabled());
    }
